...
public class Constants {
	...
	public static final String FEEDS_JOIN = "SELECT a.user_Id, a.first_name, a.middle_name, a.last_name, b.post_id, b.content, b.datetime from users a INNER JOIN post b ON a.user_id = b.user_id where a.user_id IN(SELECT profile_id from connections where user_id = ?) and a.user_id = ? ORDER BY b.datetime DESC";
